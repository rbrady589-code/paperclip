...
RUN cd server && (npx tsc --noEmit 2>&1 || true) && mkdir -p dist/onboarding-assets && cp -R src/onboarding-assets/. dist/onboarding-assets/ && echo 'export * from "../src/index.js"' > dist/index.js
